$(document).ready(function(){
	...
	//ARROW TEXT SLIDER
	var indexNum = 0;
	const quotes = ["A picture is a secret about a secret.", "You don't take a photograph, you make it.", "Photography is truth."];
	...
	//ARROW IMAGE SLIDER
	const images = ["brooke-cagle-39376", "allef-vinicius-151778-about"];
...
var Pagination = {
	...
	Create: function(e) {
		...
		var html = [
			'<a class="overline">Prev Page</a>', // previous button
